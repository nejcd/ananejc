...
(function (global, factory) {
    ...
    */
    ...
    function scrollPage(section, callback, isMovementUp) {
      ...
      extensionCall('scrollOverflowReset', 'setPrevious', v.activeSection); //pausing media of the leaving section (if we are not just resizing, as destinatino will be the same one)
    ...
    */
    ...
    function touchMoveHandler(e) {
      ...
      if (isReallyTouch(e)) {
        ...
        touchEndX = touchEvents.x; // if(getOptions().allowCorrectDirection){
        //     setState({
    ...
    */
    ...
    function onkeydown(e) {
      ...
      var isUsingHorizontalArrowKeys = [37, 39].indexOf(e.keyCode) > -1; //preventing the scroll with arrow keys & spacebar & Page Up & Down keys
